...
- (nonnull instancetype)initWithRef:(_Nonnull id)ref;
- (nullable instancetype)init:(NSString* _Nullable)secretKeyHex stateProvider:(id<IdentityStateProvider> _Nullable)stateProvider;
- (nullable instancetype)initWithData:(NSString* _Nullable)secretKeyHex userId:(NSString* _Nullable)userId stateProvider:(id<IdentityStateProvider> _Nullable)stateProvider;
@property (nonatomic) NSString* _Nonnull usedId;
...
- (NSString* _Nonnull)getPublicKeyHex;
- (NSData* _Nullable)getRegisterCallData:(NSError* _Nullable* _Nullable)error;
- (NSString* _Nonnull)getSecretKeyHex;
- (NSData* _Nullable)getTransferCalldata:(NSString* _Nullable)token amount:(NSString* _Nullable)amount to:(NSString* _Nullable)to error:(NSError* _Nullable* _Nullable)error;
...
- (void)setOldUsedId:(NSString* _Nullable)userId;
@end
...
// skipped variable AccountFactoryMetaData with unsupported type: *github.com/ethereum/go-ethereum/accounts/abi/bind.MetaData

// skipped variable AccountMetaData with unsupported type: *github.com/ethereum/go-ethereum/accounts/abi/bind.MetaData
...
// skipped function CreateAccountWithSaltCalldata with unsupported parameter or return types


// skipped function CreateTransferERC20Calldata with unsupported parameter or return types


// skipped function NewAccountCoder with unsupported parameter or return types


// skipped function NewAccountFactoryCoder with unsupported parameter or return types
...
FOUNDATION_EXPORT IdentityIdentity* _Nullable IdentityNewIdentity(NSString* _Nullable secretKeyHex, id<IdentityStateProvider> _Nullable stateProvider, NSError* _Nullable* _Nullable error);

FOUNDATION_EXPORT IdentityIdentity* _Nullable IdentityNewIdentityWithData(NSString* _Nullable secretKeyHex, NSString* _Nullable userId, id<IdentityStateProvider> _Nullable stateProvider, NSError* _Nullable* _Nullable error);
